...
def eval_xc(xc_code, rho, spin, relativity=0, deriv=2, verbose=None):
    ...
    pred_ex_lda = 0.0027368415157811958 - 0.73869995621059249 * torch.pow(x, 1/3) #lda_x_DL
    pred_c_chachiyo = - 0.0172 * torch.log(16.071131702086299 * torch.pow((- torch.pow(x, 1/3) - 0.54987870353745425), 2) - 0.08020000000000001) - 0.00463 #lda_c_chachiyo_DL
    pred_exc = pred_ex_lda + pred_c_chachiyo
#    pred_exc=model(x) #NN
