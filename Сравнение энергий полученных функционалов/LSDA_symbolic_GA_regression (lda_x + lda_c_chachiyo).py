...
def eval_xc(xc_code, rho, spin, relativity=0, deriv=2, verbose=None):
    ...
    pred_ex_lda = 0.73803226920981 * torch.pow(x, 1/3) #lda_x_GA
    pred_c_chachiyo = - 0.0605982412406733 * torch.log(torch.pow((torch.pow(x, 1/2) + 2 * x), 1/6)) - 0.0526936424244069 #lda_c_chachiyo_GA
